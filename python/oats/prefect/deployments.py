...
def upsert_deployment(
    ...
    *,
    ...
    payload = build_deployment_request(deployment_spec)
    ...
    if existing and isinstance(existing.get("id"), str):
        ...
        prefect_client.update_deployment(deployment_id, payload)
    ...
    created = prefect_client.create_deployment(payload)
...
def build_deployment_request(deployment_spec: PrefectDeploymentSpec) -> dict[str, Any]:
    return {
