...
- `src/lib/routes.ts` validates or constrains `legacy-orchestrationPath`, tab values, and related query state using explicit schemas or schema-driven allowlists.
